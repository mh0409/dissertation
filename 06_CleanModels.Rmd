...
# log Reg Model
```{r}
glm <- glm(is_mtgprisoner ~ gor_dv + urban_dv + racel_recat + sex_dv + marstat_recat + hscost + poly(age_dv, 2) + hiqual_dv + wavenumber, data = df_interest_complete, family = binomial)
...
### Model
```{r}
hsyr_glm <- glm(is_mtgprisoner ~ gor_dv + urban_dv + racel_recat + sex_dv + marstat_recat + hscost + poly(age_dv, 2) + hiqual_dv + wavenumber + hsyr04, data = df_interest_complete, family = binomial)
