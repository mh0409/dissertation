...
## NOW UPDATE THIS GRAPH TO SHOW
# pdf("/Users/mariajoseherrera/Documents/LSE_new/03_Dissertation/Understanding_Society/results_2clust_pct_boxplots.pdf") ## CHANGE FILE NAME
# ggplot(data = df_cat_percent, aes(x = value, y = pct,  fill = cluster2)) +
#   geom_col(position = "dodge") + 
#   facet_wrap(~variable, scales = "free")
# dev.off()
...
#
## NOW UPDATE THIS GRAPH TO SHOW
# pdf("/Users/mariajoseherrera/Documents/LSE_new/03_Dissertation/Understanding_Society/results_4clust_pct_boxplots.pdf") ## UPDATE NAME
# ggplot(data = df_cat_percent, aes(x = value, y = pct,  fill = cluster4)) +
#   geom_col(position = "dodge") + 
#   facet_wrap(~variable, scales = "free")
# dev.off()
